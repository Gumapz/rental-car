			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="#">Accepted Booking</a>
						</li>
					</ul>
				</div>
                ...
                <div class="brands-box">
					...
					<?php
						...
						$sql = "SELECT COUNT(*) as total FROM `booking`
								WHERE status = 1 AND name LIKE '%$searchQuery%'";
						...
						$sql = "SELECT b.*, p.image AS payment_image, p.status AS payment_status 
								...
								WHERE b.status = 1 AND b.name LIKE '%$searchQuery%'
						...
						if ($result && $result->num_rows > 0) {
							foreach ($result as $r) {
								...
								<tr class="gradeX">
									...
									<td style="text-align: center;"><?php echo htmlspecialchars($r['returned']); // Display returned status ?></td>
									<td style="text-align: center;"><?php echo htmlspecialchars($r['date']); // Display the date ?></td>
									<td style="text-align: center;">
